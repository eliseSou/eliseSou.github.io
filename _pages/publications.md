...
We sued 33,707 arisu data for learning and evaluation because of the learning time and storage capacity. In addition, because the YOLO model uses 640X480 size images, we resized all images to 640X480
